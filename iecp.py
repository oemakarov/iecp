...
class IECP():
    ...
    def request_list(self, filter: RequestListFilter) -> Tuple[bool, 
                                                            RequestListResponse]:
    ...
    def request_change(self, request_id: int, info: Optional[RequestInfo] = None, 
                        request_archived: bool = None) -> Tuple[bool, str]:
    ...
    def _process_response(self, response: requests.Response, 
                            model: BaseModel) -> Tuple[bool, BaseModel]:
